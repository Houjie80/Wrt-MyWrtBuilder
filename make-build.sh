...
# Adguardhome
PACKAGES+=" luci-app-rakitanmanager luci-app-passwall luci-app-tailscale luci-app-droidnet luci-app-tinyfm luci-app-ipinfo luci-theme-initials ca-certificates ca-bundle tar unzip bind-tools"
